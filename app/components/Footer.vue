...
<template>
    <footer class="footer">
        <div class="footer-nav">
            <NuxtLink v-for="link in footer.navigation_links" :key="link.id" :to="link.url" class="nav-item">
                {{ link.label }}
            </NuxtLink>
        </div>

        <div class="social">
            <a v-for="social in footer.social_links" :key="social.id" :href="social.url" target="_blank"
                class="social-item">
